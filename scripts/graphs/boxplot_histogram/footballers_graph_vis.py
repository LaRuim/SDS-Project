...
plt.xlabel(" Centre Backs' Overall")
plt.ylabel("Number of players")
plt.show()
free_roamers.hist(column='overall')
plt.xlabel("Free Roamers' Overall")
plt.ylabel("Number of players")
plt.show()
full_backs.hist(column='overall')
plt.xlabel("Full Backs' Overall")
plt.ylabel("Number of players")
plt.show()
midfielders.hist(column='overall')
plt.xlabel("Midfielders' Overall")
plt.ylabel("Number of players")
plt.show()
strikers.hist(column='overall')
plt.xlabel("Strikers' Overall")
plt.ylabel("Number of players")
plt.show()
wingers.hist(column='overall')
plt.xlabel("Wingers' Overall")
plt.ylabel("Number of players")
plt.show()
...
ax.set_xticklabels(['Centre Backs', 'Free Roamers', 'Full Backs', 'Midfielders', 'Strikers', 'Wingers'])
